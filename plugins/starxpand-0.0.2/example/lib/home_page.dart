...
class _HomePageState extends State<HomePage> {
  ...
  ///  监听打印
  _startInputListener(StarXpandPrinter printer) async {
    if (guide.isNotEmpty) {
      await StarXpand.stopInputListener(printer, guide);
    }
    guide = await StarXpand.startInputListener(printer, (p) {
      showToast(p.inputString);
    });
  }
